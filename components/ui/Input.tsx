    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={cn(
            "w-full rounded-xl border border-border bg-white/5 px-4 py-3 text-foreground placeholder:text-muted/50 outline-none transition-colors duration-150 focus:border-primary focus:ring-2 focus:ring-primary/30",
